...
/*!40000 ALTER TABLE `energia`
    DISABLE KEYS */;
INSERT INTO `energia`
VALUES (1, 'Jun', 'El Todo, La Unidad, El Absoluto, La Pureza',
        'Principio de Unidad.<br><span></span>Propósito, Atraer, Unificar.<br><span></span>El principio y origen, el ser humano como un todo.<br><span></span>La unidad establece el propósito, el objeto y la meta de acción por pequeña que esta sea.<br><span></span>La unidad es el todo, la unica verdad absoluta, es la creacion mental del todo.<br><span></span>En el circulo de la perfección todos los seres estan unidos inseparablemente sin importar su dimension de manifestacion, la creencia de que no es asi, crea una grieta en la relación original y esa grieta en el campo de energía crea una polaridad (como proceso de cicatrizacion) que ha de convertirse en vibración.',
        'Jun', 'Energia_1'),
       (2, 'Keb\'', 'La Pareja, La Polaridad, El Complemento, El Apoyo',
        'Principio de Polaridad.<br><span></span>Desafío, Estabilizar, Polarizar.<br><span></span>Esqueleto y esencia, Masculino y femenino; forman el principio generador dual, la simetría dual de los seres. Son los extremos de un mismo fenómeno, opuestos idénticos en su naturaleza: espíritu y materia, luz y oscuridad, ying y yang.<br><span></span>Armonizar la vibración es resolver la polaridad equilibrando los dos extremos, o sea, incluyéndolos<br><span></span>Si todo es luz, las formas se difuminan, por eso es necesario el contraste de las sombras.<br><span></span>Cultivar nuestra resonancia es armonizar nuestra vibracion con resonancias superiores como la planetaria, solar y galáctica.',
        'Ka\'a', 'Energia_2'),
       (3, 'Oxib', 'Los Resultados, Los Hijos, El Temor, Los Frutos',
        'Principio del ritmo o compensación.<br><span></span>Servicio, Unir, Activar.<br><span></span>Flujo y reflujo, ascenso y descenso, accion y relacion; es el movimiento entre los polos de todos los planos (físico, mental y espiritual).<br><span></span>Cada fenómeno, cada proceso tiene su propio ritmo: todo tiene un inicio, nace, crece, muere y renace. Liquido precioso que da calor y energia al cuerpo, sangre, el agua de la naturaleza, lluvia.<br><span></span>Al crear polaridades, desencadenamos eventos, circunstancias que experimentamos y superamos, las acciones que producen un campo de natividad (ignorancia, oscuridad espiritual) son kharmas, las acciones que suprimen y corrigen la negatividad (sabiduría) son Dharmas y crean un campo benéfico.',
        'Ox', 'Energia_3'),
       (4, 'Kajib\'', 'La Solidez, La Fortaleza, La Felicidad, La Estabilidad',
        'Principio de la medida.<br><span></span>Forma, Medir, Definir.<br><span></span>El cuatro como medida de todas las estructuras materiales (la pirámide), entra siempre en relación con la composición trina de lo espiritual, formando la estructura Septernal de todo lo que Es.<br><span></span>El poder del ordenamiento matemático del macro y microcosmos. Todo cuanto existe es segun la medida de la ley del todo.<br><span></span>Establece los limites de las estructuras; las 4 fuerzas principales, 4 rumbos sagrados, 4 elementos: calor, viento y agua sobre tierra. Cuatro son las regiones mayas, 4 los elementales, 4 los nucleidos, 4 los elementos químicos primarios, 4 las razas cósmicas, rumbos cardinales, estaciones solares, chacras de personalidad, etc',
        'Kan', 'Energia_4'),
       (5, 'Job\'', 'El Amor, El Trabajo, El Esfuerzo, Analizar',
        'Principio de lo nuclear.<br><span></span>Esplendor, Mandar, Dar poder.<br><span></span>La capacidad de realización, la movilidad de los dedos, percibir la belleza de la naturaleza, el 5� punto o centro del Universo.<br><span></span>Toda unidad, por pequeña que sea, objetiva o subjetiva comporta un núcleo como tractor y una periferia de manifestación (núcleo del átomo y electrones, por ejemplo).<br><span></span>Deriva la concepción del matiz cromático de cinco, que es la acción de la quinta fuerza galáctica; el matiz del color da la entonación.',
        'Jo', 'Energia_5'),
       (6, 'Waquib', 'El Mundo Material, La Materia, La Amistad, La Reacción',
        'Principio del equilibrio orgánico: 2x3. (Polaridad por ritmo)<br><span></span>Igualdad, Equilibrar, Organizo.<br><span></span>La polaridad del ritmo genera el principio orgánico, la ley del ordenamiento Hexagonal de las estructuras cristalinas y celulares. La tendencia de las estructuras ligadas al proceso de la vida es la de alcanzar el equilibrio relativo, estado de realización intermedio, a partir del cual continuar el movimiento hacia la conciencia superior.<br><span></span>El principio del Diferencial de Potencial aporta la resolución de situaciones a traves de saltos cualitativos entre estados de la energía. Nada de cuanto sucede es casual, todo esta sujeto al poder de la ley primigenia; todo efecto tiene su causa y a la vez es causal de otros efectos, la Causa Centro Primera es el Creador.<br><span></span>Su acción es equilibrar, el principio de la integración de nuestra introspección',
        'Wak', 'Energia_6'),
       (7, 'Wuqub', 'El Equilibrio, El Movimiento, El Integrar, El Realizar',
        'Principio de unificación mental. (Poder místico)<br><span></span>Armonizar, Inspirar, Canalizo.<br><span></span>Los hombres somos unidades resonantes dentro de un todo Mental, el orden material es un fractal del ordenamiento mental del universo; nosotros no controlamos la mente, somos pensados por la mente, vivimos inmersos en ella.<br><span></span>El siete canaliza energía inspirando la armonizacion. Representa las fases lunares de 7 días, el segundo paso de la transformación interior; el intelecto activo, inquieto, la influencia lunar.',
        'Uuk', 'Energia_7'),
       (8, 'Waqxaqib', 'La Espiritualidad, El Arte, La Alegría, La Energía Masculina',
        'Principio de Resonancia armónica. (Octavas resonantes)<br><span></span>Integridad, Modelar, Armonizar.<br><span></span>Así como en música, las escalas se suceden en octavas, las energías vibratorias contactan y resuenan con sus respectivas equidistantes en los niveles superiores e inferiores de manifestación, como también con los armónicos secundarios derivados de la vibración.<br><span></span>Las octavas son el vehículo de información del todo, como ley de la armonía; el tono ocho otorga la habilidad de dar forma, de modelar, de describir aspectos del nivel inmediatamente superior de vibración.<br><span></span>Ocho es la esencia interior, el ser como recipiente de la esencia cósmica, el 2 veces NAHUI (4), conjuga las 4 direcciones (+) y los 4 rincones (X) del mundo.',
        'Waxac', 'Energia_8'),
       (9, 'Belejeb', 'La Realización, El Poder, Acción, La Energía Femenina',
        'Principio de la Periodicidad ciclica.<br><span></span>Intención, Realizar, Pulso.<br><span></span>Todo cuanto se mueve lo hace de acuerdo a la Ley Cósmica; la periodicidad cíclica, no la repetición de los sucesos, es la cualidad por la que un evento se asocia a otros anteriores y posteriores en el tiempo como fenómenos resonantes (ciclos entre ciclos).<br><span></span>Representa lo femenino del principio generatriz (Yin), el polo creativo en el cual se manifiesta la generación o producción de formas, energías y conceptos nuevos dinamizadores del proceso evolutivo de la vida, el objetivo; la intención de poner la acción en movimiento',
        'Bolon', 'Energia_9'),
       (10, 'Lajuj', 'La Ley, La Autoridad, La Rectitud, La Impecabilidad',
        ...
        'Lajun', 'Energia_10'),
       (11, 'Julajuj', 'Compartir, Separar, Las Posibilidades, Dejarse-abandonarse',
...
/*!40000 ALTER TABLE `kin`
    DISABLE KEYS */;
INSERT INTO `kin`
VALUES (0, 1, 'Imix\'', 'Dragon',
       ...
       (4, 5, 'Chikchan', 'La Serpiente',
        ...
        'Kin_4', 'Chicchan'),
       (5, 6, 'Kimi', 'El enlazador de mundos',
       ...
       (11, 12, 'Eb\'', 'El humano',
        ...
        'Kin_11', 'Eb'),
       (12, 13, 'B\'en ', 'El caminante del cielo',
...
/*!40000 ALTER TABLE `nahual`
    DISABLE KEYS */;
INSERT INTO `nahual`
VALUES (0, 15, 'Tzi\'kin', NULL, 'Pajaro',
       ...
       (1, 16, 'Ajmaq', NULL, 'Búho, falta o culpa',
       ...
       (2, 17, 'No\'j', NULL, 'Idea o sabiduria',
       ...
       (3, 18, 'Tijax', NULL, 'Pedernal o obsidiana',
       ...
       (4, 19, 'Kawoq', NULL, 'Trueno o dificultad',
       ...
       (5, 20, 'Ajpu', NULL, 'Cerbatanero o señor principal',
       ...
       (8, 3, 'Aq´ab´al', NULL, 'Amanecer, aurora y mano',
       ...
       (9, 4, 'K´at', NULL, 'Red, cautiverio o iguana',
       ...
       (10, 5, 'Kan', NULL, 'Serpiente emplumada',
       ...
       (11, 6, 'Kame', NULL, 'Muerte o dueño de la oscuridad',
       ...
       (13, 8, 'Q\'anil', NULL, 'Semilla, simiente o conejo',
       ...
       (14, 9, 'Toj', NULL, 'Ofrenda, pago o lluvia',
       ...
       (15, 10, 'Tz\'i\'', NULL, 'Perro o mapache',
       ...
       (18, 13, 'Aj', NULL, 'Caña o cañaveral',
...
/*!40000 ALTER TABLE `pagina`
    DISABLE KEYS */;
INSERT INTO `pagina`
VALUES (2, 'Energia', 'Calendario Cholquij', 'Elementos',
       ...
       (3, 'Forma de Contar', 'Calendario Cholquij', 'Informacion',
       ...
       (0, 'Informacion', 'Calendario Cholquij', 'Informacion',
       ...
       (2, 'Uinal', 'Calendario Haab', 'Elementos',
...
LOCK TABLES `uinal` WRITE;
/*!40000 ALTER TABLE `uinal`
    DISABLE KEYS */;
INSERT INTO `uinal`
VALUES (0, 'Wayeb\'', 'Dias desafortunados, reflexion, gracia y penitencia', 5,
        ...
        'Uinal_0', 18, 'src/imagenesWinales/19.png'),
       (1, 'Pop', 'Mat (símbolo de comunidad y matrimonio), petate', 20,
        ...
        'Uinal_1', 0, 'src/imagenesWinales/1.png'),
       (2, 'Woo', 'Rana, sapo, negro', 20,
        ...
        'Uinal_2', 1, 'src/imagenesWinales/2.png'),
       (3, 'Zip', 'Rojo, conjuncion', 20,
        ...
        'Uinal_3', 2, 'src/imagenesWinales/3.png'),
       (4, 'Sotz\'', 'Bat (murcielago)', 20,
        ...
        'Uinal_4', 3, 'src/imagenesWinales/4.png'),
       (5, 'Tzek', 'Fin, palma, calavera', 20,
        ...
        'Uinal_5', 4, 'src/imagenesWinales/5.png'),
       (6, 'Xul', 'Perro, instrumento musical', 20,
        ...
        'Uinal_6', 5, 'src/imagenesWinales/6.png'),
       (7, 'Yaxk\'in', 'Primer Sol (o verde), inicio agricola, nuevo dia', 20,
        ...
        'Uinal_7', 6, 'src/imagenesWinales/7.png'),
       (8, 'Mol', 'Inicio de lluvia, agua, jade', 20,
        ...
        'Uinal_8', 7, 'src/imagenesWinales/8.png'),
       (9, 'Ch\'en', 'Lluvia, negro, acido', 20,
        ...
        'Uinal_9', 8, 'src/imagenesWinales/9.png'),
       (10, 'Yax', 'Verde, humedad', 20,
        '<p>En este mes hacían una fiesta llamaba <strong>ocná</strong>, que quiere decir <em>«renovación del templo»</em>, la hacían en honor de los dioses de los maizales; los mayas acostumbraban tener ídolos de los dioses con pequeños braseros en donde quemaban copal, en esta fiesta cada año se renovaban los ídolos de barro y sus braseros.</p>',
        'Uinal_10', 9, 'src/imagenesWinales/10.png'),
       (11, 'Sak', 'Blanco, lluvia', 20,
        ...
        'Uinal_11', 10, 'src/imagenesWinales/11.png'),
       (12, 'Keh', 'Rojo, venado', 20,
        ...
        'Uinal_12', 11, 'src/imagenesWinales/12.png'),
       (13, 'Mak', 'Red, cautiverio, pecado', 20,
       ...
       (15, 'Muwan', 'Halcon, buho', 20,
        ...
        'Uinal_15', 14, 'src/imagenesWinales/15.png'),
       (16, 'Pax', 'Tiempo de siembra, tambor, musica', 20,
        ...
        'Uinal_16', 15, 'src/imagenesWinales/16.png'),
       (17, 'K\'ayab\'', 'Tortuga, guacamaya', 20,
        ...
        'Uinal_17', 16, 'src/imagenesWinales/17.png'),
       (18, 'K\'umk\'u\'', 'Maiz maduro, granero, oscuridad', 20,
        '<p>Durante los meses <strong>kayab </strong>y <strong>Kumku </strong>en cada población hacían fiestas a las cuales llamaban <strong>zabacilthan</strong>, se reunían para presentar ofrendas, comer y beber preparándose para el <strong><em>uayeb</em></strong>, el mes corto de los cinco días nefastos. </p>',
        'Uinal_18', 17, 'src/imagenesWinales/18.png');
/*!40000 ALTER TABLE `uinal`
    ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2021-10-16  1:58:23
