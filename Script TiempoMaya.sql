...
INSERT INTO `energia` (`id`, `nombre`, `significado`, `htmlCodigo`, `nombreYucateco`, `categoria`)
VALUES (1, 'Jun', 'El Todo, La Unidad, El Absoluto, La Pureza',
       ...
       (5, 'Job\'', 'El Amor, El Trabajo, El Esfuerzo, Analizar',
        ...
        'Jo', 'Energia_5'),
       (6, 'Waqib\'', 'El Mundo Material, La Materia, La Amistad, La Reacción',
       ...
       (7, 'Wuqub\'', 'El Equilibrio, El Movimiento, El Integrar, El Realizar',
        ...
        'Uuk', 'Energia_7'),
       (8, 'Wajxaqib\'', 'La Espiritualidad, El Arte, La Alegría, La Energía Masculina',
        ...
        'Waxac', 'Energia_8'),
       (9, 'B\'elejeb\'', 'La Realización, El Poder, Acción, La Energía Femenina',
       ...
       (11, 'Julajuj', 'Compartir, Separar, Las Posibilidades, Dejarse-abandonarse',
        ...
        'Buluk', 'Energia_11'),
       (12, 'Kab\'lajuj', 'La Familia, La Comunidad, Los Grupos, La Seguridad',
...
INSERT INTO `kin` (`id`, `iddesk`, `nombre`, `significado`, `htmlCodigo`, `categoria`, `nombreYucateco`)
...
INSERT INTO `nahual` (`idweb`, `iddesk`, `nombre`, `nombreYucateco`, `significado`, `htmlCodigo`, `categoria`,
                      `descripcion`, `rutaEscritorio`)
VALUES (0, 15, 'Tzikin', NULL, 'Pajaro',
...
VALUES (2, 'Energia', 'Calendario Cholquij', 'Elementos',
       ...
       (0, 'Forma de Contar', 'Calendario Cholquij', 'Informacion',
...
INSERT INTO `uinal` (`idweb`, `nombre`, `significado`, `dias`, `htmlCodigo`, `categoria`, `iddesk`, `ruta`)
